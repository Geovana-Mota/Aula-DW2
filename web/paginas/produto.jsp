                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Quantidade em estoque" style="width: 189px;">Quantidade</th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Categoria do produto" style="width: 147px;">Categoria</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <%
                                        ...
                                        <tr>
                                            ...
                                            <td><%=formatoDinheiro.format(p.getPrecoProduto())%></td>
                                            <td><%=p.getQuantidadeProduto()%></td>
                                            <td><%=p.getCategoriaIdCategoria().getNomeCategoria()%></td>
                                        </tr>
                                        <%}%>
                                    </tbody>
                                </table></div></div>
